from behavior_prompting.train_network.model.common.normalizer import SingleFieldLinearNormalizer
from behavior_prompting.common.pytorch_util import dict_apply_reduce, dict_apply_split
import numpy as np
import torch
